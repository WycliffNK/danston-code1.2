...
export const metadata = {
  ...
  description:
    "RestoreMe is a personal restoration and confidence programme from Code 1.",
};
    ...
    <>
      ...
      <section className="relative min-h-[90vh] bg-navy flex items-end px-[var(--rail-x)] pb-20 pt-40 overflow-hidden">
        <div className="absolute inset-0 opacity-[0.04]"
          style={{ backgroundImage: "radial-gradient(circle at 30% 60%, #C9A961 0%, transparent 60%)" }}
        />
