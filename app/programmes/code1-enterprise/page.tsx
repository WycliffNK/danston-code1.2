...
export const metadata = {
  ...
  description:
    "Code1 Enterprise is a leadership and organisational restoration programme from Code 1.",
};
    ...
    <>
      ...
      <section className="relative min-h-[90vh] bg-navy flex items-end px-[var(--rail-x)] pb-20 pt-40 overflow-hidden">
        <div className="absolute inset-0 opacity-[0.04]"
          style={{ backgroundImage: "radial-gradient(circle at 60% 30%, #C9A961 0%, transparent 60%)" }}
        />
        <div className="relative z-10 max-w-3xl">
          ...
          <h1 className="font-serif text-5xl sm:text-6xl lg:text-7xl text-cream leading-[1.05] mb-8">
            Code1<br />
            <em className="text-gold">Enterprise</em>
          </h1>
          <p className="font-sans text-lg sm:text-xl text-cream/70 leading-relaxed max-w-xl mb-12">
            Leadership and organisational restoration. Coming soon.
          </p>
          <Link
            href="/#assessment"
